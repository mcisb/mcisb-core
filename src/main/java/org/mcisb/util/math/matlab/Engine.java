...
class Engine
{
	 ...
	 * @throws java.io.IOException Thrown if starting the process was not successful.
	 */
	 ...
	 * @throws java.io.IOException Thrown if Matlab could not be closed. 
	 */
	 ...
	 * @throws java.io.IOException Thrown if data could not be sent to Matlab. This
