...
public abstract class DataDisplayPanel extends JPanel implements Manipulatable, Disposable
{
	 ...
	 * 
	 */
	protected final static int AXES_BORDER = 50;

	/**
	 * 
	 */
	protected final static int TEXT_BORDER = 10;

	/**
	 * 
	 */
	protected final static int LABEL_BORDER = 2;

	/**
	 * 
	 */
	protected final static int MAJOR_MARK_LENGTH = 5;

	/**
	 * 
	 */
	protected final static int MINOR_MARK_LENGTH = 2;

	/**
	 * 
	 */
	protected final static String AXIS_PATTERN = "####0.0"; //$NON-NLS-1$

	/**
	 * 
	 */
	protected final static String DOUBLE_PATTERN = "####0.0000"; //$NON-NLS-1$

	/**
	 * 
	 */
	private static final String START_HIGHLIGHT = "0x00C000"; //$NON-NLS-1$

	/**
	 * 
	 */
	private static final String END_HIGHLIGHT = "0xFF0000"; //$NON-NLS-1$

	/**
	 * 
	 */
	protected java.util.List<Spectrum> spectra = new ArrayList<>();
	 ...
	 * 
	 */
	protected String xAxisLabel = ""; //$NON-NLS-1$

	/**
	 * 
	 */
	protected String yAxisLabel = ""; //$NON-NLS-1$

	/**
	 * 
	 */
	protected String yAxisUnits = ""; //$NON-NLS-1$
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mcisb.ui.util.Manipulatable#setXRangeByPosition(double, double)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mcisb.ui.util.Manipulatable#reset()
	 */
	@Override
	public void reset()
	{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mcisb.ui.util.Manipulatable#getAxesBorder()
	 */
	@Override
	...
	protected void paintAxes( final Graphics2D g )
	{
		...
		final String Y_AXIS_ANNOTATION = yAxisLabel + ( ( yAxisRelative ) ? " / %" : ( yAxisUnits.length() > 0 ) ? " / " + yAxisUnits : "" ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		if( yAxisRelative )
		{
			final String COUNTS_ANNOTATION = "100% = " + StringUtils.getEngineeringNotation( maxY * scaleY ) + " " + yAxisUnits; //$NON-NLS-1$ //$NON-NLS-2$
